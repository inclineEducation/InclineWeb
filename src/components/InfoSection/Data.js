...
export const homeObjOne = {
  ...
  lightText: true,
  lightTextDesc: true,
  topLine: 'Incline Education',
  headline: 'What We Do',
  description: 'Incline Education provides panel discussions, mentorship services and educational blog articles to communicate key insights about how high school students can prepare for higher education and beyond.',
  buttonLabel: 'Learn More',
  imgStart: false,
  img: require('../../images/organize-resume.svg').default,
  alt: 'blank',
  primary: true,
  darkText:false
};
